...
const Navbar = () => {
    ...
    return (
        <div className="w-full h-[6vh] flex my-[1vh]">
            {/*LOGO*/}
            <NavLink to="/" className="md:w-1/6 md:h-full w-[120px] flex justify-center items-center">
            ...
            <div className="w-1/6 bg-yellow-500 flex justify-center items-center text-xl">
                <button className="flex items-center bg-bleu-sud text-white font-bodyText font-bold px-3 py-2 rounded-xl hover:bg-orange-sud">
