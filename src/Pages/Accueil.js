...
const Accueil = () => {
    return (
        <div className="md:min-h-[88vh] flex flex-col pb-5 md:pb-0 animate-appear bg-gris-sud-light">
            ...
            <div className="md:hidden w-full flex flex-col justify-center mt-5">
                <div className="font-header text-bleu-sud font-bold text-center text-3xl">
                    Vous relogez vos salariés ?
                </div>
                <div className="font-header text-orange-sud font-bold text-center text-3xl md:text-4xl pb-5">
                    <span>
                        Le soleil les attend !
                    </span>
                </div>
